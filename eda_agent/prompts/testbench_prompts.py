"""Cocotb testbench generation, repair, and diagnostic prompt templates."""
...
2. Synchronous signal driving & sampling:
   ...
   - To avoid delta-cycle race conditions when reading outputs after a clock edge, wait for signal settling (`await Timer(1, unit="ns")`).
